...
export default async function ContributorsAdminPage(){
 ...
 const [profilesResult,gamesResult,pendingResult,assignmentsResult,coverageResult]=await Promise.all([
 ...
 return <div className="space-y-6"><CoverageBoard profiles={profiles} games={games} requests={coverageResult.results||[]} /><ContributorAdmin profiles={profiles} games={games} pendingUpdates={pendingUpdates} assignments={assignmentsResult.results||[]} /></div>
}
