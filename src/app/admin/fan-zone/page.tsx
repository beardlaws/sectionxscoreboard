...
export default async function FanZoneAdminPage(){
 ...
 const [{data:plays},{data:snapshots}]=await Promise.all([
 ...
 return <AdminLayout><div className="p-4 max-w-6xl"><h1 className="text-2xl font-black text-white">Fan Zone Control Room</h1><p className="text-sm text-slate-500 mt-1 mb-5">Review Top 5 Play nominations and watch fan power-ranking ballots build.</p><FanZoneAdminClient plays={plays||[]} snapshots={snapshots||[]}/></div></AdminLayout>
}
