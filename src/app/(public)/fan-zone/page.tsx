...
export default async function FanZonePage(){
 ...
 const [{data:season},{data:sports},{data:schools},{data:snapshots},{data:featured},{data:schoolVotes}]=await Promise.all([
 ...
 return <PublicLayout><main className="max-w-5xl mx-auto px-4 py-7">
  <section className="relative overflow-hidden rounded-[28px] border border-blue-400/15 bg-gradient-to-br from-blue-500/[.12] via-white/[.025] to-yellow-300/[.06] p-6 sm:p-8 mb-7">
    ...
    <div className="relative">
      ...
      <h1 className="mt-2 text-4xl sm:text-5xl font-black text-white leading-[.95]">Make the plays. Rank the teams.<br/><span className="text-yellow-300">Rep your school.</span></h1>
      <p className="mt-4 max-w-2xl text-sm sm:text-base text-white/45">This is where Section X arguments become official. Nominate a Top 5 moment, build your own power rankings, and show us which school has the loudest fanbase.</p>
